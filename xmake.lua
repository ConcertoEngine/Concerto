...
add_requires('nazaraengine', {configs = {audio = false, network = false, physics2d = false, physics3d = false, utility = false}})
...
target('Concerto')
    ...
    add_files('src/*.cpp', 'src/ecs/*.cpp', 'src/math/*.cpp', 'src/ecs/systems/*.cpp')
    set_optimize('none')
